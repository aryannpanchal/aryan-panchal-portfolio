...
const Offer = () => {
  return (
    <>
      <div className="container relative flex flex-col justify-between h-full max-w-6xl px-10 mx-auto laptop:px-0 laptop:mb-44 mobile:mb-28">
              ...
              <div className="relative h-full ml-0 mr-0 mobile:mr-0">
                ...
                <div className="relative h-full p-5 bg-white border-2 border-black rounded-lg">
                  <div className="flex items-center -mt-1">
                    <h3 className="my-2 ml-3 laptop:text-2xl mobile:text-lg font-bold text-black">Web Development</h3>
                  </div>
          ...
          <div className="flex flex-col w-full mb-5 mobile:flex-col laptop:flex-row laptop:gap-8 mobile:mt-0 mobile:pt-0"> {/* Add gap-8 for spacing */}
            <div className="w-full mb-10 mobile:mb-5 laptop:mb-0 laptop:w-1/2">
              <div className="relative h-full ml-0 mr-0 mobile:mr-0">
                ...
                <div className="relative h-full p-5 bg-white border-2 border-black rounded-lg">
                  <div className="flex items-center -mt-1">
                    <h3 className="my-2 ml-3 laptop:text-2xl mobile:text-lg  font-bold text-black">Content Creation</h3>
                  </div>
                  {/* <p className="mb-2 text-gray-600 text-lg">
            ...
            <div className="w-full mb-10 mobile:mb-5 laptop:mb-0 mobile:mt-4 laptop:w-1/2">
              <div className="relative h-full ml-0 mr-0 mobile:mr-0">
                ...
                <div className="relative h-full p-5 bg-white border-2 border-black rounded-lg">
                  <div className="flex items-center -mt-1">
                    <h3 className="my-2 ml-3 laptop:text-2xl mobile:text-lg  font-bold text-black">Scalability</h3>
                  </div>
                  {/* <p className="mb-2 text-gray-600 text-lg">
            ...
            <div className="w-full laptop:w-1/2">
              <div className="relative h-full ml-0 laptop:mr-10 mobile:mt-4">
                ...
                <div className="relative h-full p-5 bg-white border-2 border-black rounded-lg">
                  <div className="flex items-center -mt-1">
                    <h3 className="my-2 ml-3 laptop:text-2xl mobile:text-lg  font-bold text-black">Machine Learning & Research</h3>
                  </div>
                  {/* <p className="mb-2 text-gray-600 text-lg">
