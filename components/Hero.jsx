  ...
  return (
    ...
    <div className="flex mobile:flex-col  laptop:flex-row items-center justify-between w-full mobile:my-24 mobile:mb-[230px] laptop:mt-0 laptop:mb-12 h-screen px-4 mobile:px-8 laptop:px-16 bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center items-start space-y-4 mobile:pr-8 ">
        ...
        <Link target="__blank" href='/Resume.pdf'><button className="bg-black text-white px-4 py-1 rounded-lg border-primary border-2 font-semibold hover:bg-white hover:text-black transition">
    ...
    <section className="relative bg-primaryDark laptop:h-[700px] max-w-screen overflow-hidden laptop:-translate-y-40">
      {/* SVG Wave */}
      {/* <svg
        ...
        <div className="h-full  border-opacity-60 rounded-lg overflow-hidden border-2 border-white">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-center mt-8 flex-wrap">
              <a href='/projects' className="bg-white text-black px-4 py-1 rounded-lg border-primary hover:bg-primaryDark hover:text-white transition border-2 font-semibold text-ce">View all projects ➔
              </a>
            </div>
          </div>
        </div>
