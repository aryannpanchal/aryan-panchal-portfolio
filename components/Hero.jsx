...
const HeroSection = () => {
  return (
    <>
    {/* <section class="relatve mt-24">
  <div class="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
    <div class="mx-auto mb-12 w-full max-w-3xl text-center md:mb-16 lg:mb-20">
      <h1 class="mb-4 text-4xl font-semibold md:text-6xl">The Website You Want Without The <span class="bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/6390526ac2a607693620c97b_Rectangle%2010.svg')] bg-cover bg-center px-4 text-white">Dev Time</span>.</h1>
      <p class="mx-auto mb-5 max-w-[528px] text-xl text-[#636262] lg:mb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis, lectus</p>
...
{/* <svg
  ...
  height="390"
  width="614"
  className='mobile:max-w-[400px] laptop:max-w-[700px] laptop:mt-12'
>
  <g id="Frame">
    <g id="box-figma">
    <text
  ...
  fill="black"
>
  <tspan x="80" dy="0">Frontend, UI-UX</tspan>
  <tspan x="80" dy="48">Machine learning</tspan>
</text>
  ...
  <span className="folderContainer w-10 h-fit flex flex-col items-center justify-end relative">
    <svg
      className="fileBack z-10 w-4/5 h-auto"
      width="146"
      height="113"
      viewBox="0 0 146 113"
      fill="none"
    ...
    <svg
      className="filePage w-1/2 h-auto absolute z-20 transition-all duration-300 ease-out translate-y-0 hover:translate-y-[-5px]"
      width="88"
      height="99"
      viewBox="0 0 88 99"
      fill="none"
    ...
    <svg
      className="fileFront w-[85%] h-auto absolute z-30 opacity-95 transform origin-bottom transition-all duration-300 ease-out rotate-x-0 hover:rotate-x-30"
      width="160"
      height="79"
      viewBox="0 0 160 79"
      fill="none"
  ...
  <p className="text text-white text-sm font-semibold tracking-wide">View my resume</p>
</button>
        </Link>
      </div>
