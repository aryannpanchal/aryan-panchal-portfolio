...
const Footer = () => {
  return (
    <>
 <div class="px-4 pt-16 mx-auto sm:max-w-xl mobile:max-w-full laptop:max-w-screen-xl md:px-24 laptop:px-8">
  <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 laptop:grid-cols-4">
    <div class="sm:col-span-2">
      ...
      <div class="mt-6 laptop:max-w-sm">
  ...
  <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t laptop:flex-row">
