...
const Projects = () => {
          ...
          <div className="rounded-lg overflow-hidden shadow-lg ring-2 ring-primaryDark">
            ...
            <div className="p-4">
              ...
              <div className="flex flex-row justify-center laptop:space-y-0 gap-4 laptop:space-x-4">
                {/* App Store Button */}
                <Link href='/' className="flex items-center justify-center w-48 h-14 text-black bg-transparent border border-black rounded-lg hover:bg-gray-800 hover:text-white transition duration-300">
                  <div className="mr-2">
  ...
  >
    <div className="flex h-10 w-10 items-center justify-center space-x-2 rounded-md border border-primary border-muted bg-muted">
    ...
    <div className="flex items-center">
      ...
      <div className="flex h-10 items-center rounded-md bg-gray-100 border-primary border px-4 font-medium hover:text-white hover:bg-primaryDark transition">
