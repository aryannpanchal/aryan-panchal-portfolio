          ...
          <div className="rounded-lg overflow-hidden shadow-lg ring-2 ring-primaryDark">
            ...
            <div className="p-4">
              ...
              <div className="flex flex-row justify-center laptop:space-y-0 gap-4 laptop:space-x-4">
                {/* App Store Button */}
                <Link href='fg' type="button" className="flex items-center justify-center w-48 h-14 text-black bg-transparent border border-black rounded-lg hover:bg-gray-800 hover:text-white transition duration-300">
                  <div className="mr-2">
                ...
                {/* Google Play Button */}
                <Link href='gs' type="button" className="flex items-center justify-center w-48 h-14 text-white bg-black rounded-lg hover:bg-transparent hover:border-primaryDark border-2 hover:text-black transition duration-300">
                  <div className="mr-2">
